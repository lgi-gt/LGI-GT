...
class GraphTransformer(Module): 
    ...
    def forward(self, data: Data) -> Tensor: 
        ...
        #     # x = self.edge_attr_mp(x, edge_index, edge_attr) 
        #     # x = self.node_edge_mlps[i](x) 
        #     # x = self.gconvs[i](x, edge_index) 

        #     # x = self.gconvs[3*i](x, edge_index) 
        #     # x = self.bns[2*i](x) 
        #     # x = self.gconvs[3*i+1](x, edge_index) 
        #     # x = self.bns[2*i+1](x) 
        #     # x = self.gconvs[3*i+2](x, edge_index) 
