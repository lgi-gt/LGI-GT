...
parser.add_argument('--device', type=str, choices=['0', '1', '2', '3', 'cpu'], default='cpu') 

parser.add_argument('--save-state', action='store_true') 

parser.add_argument('--clipping_mode', type=str, default='tail', choices=['tail', 'head', 'head+tail'])
...
from lgi_gt_clip import LGI_GT_clip  
...
dataset.transform = transforms.Compose([augment_edge, lambda data: encode_y_to_arr(data, vocab2idx, args.max_seq_len),  clip_wrapper(args.clipping_mode)]) 
# pre-processing done 
