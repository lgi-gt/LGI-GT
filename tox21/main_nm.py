...
parser.add_argument('--gconv-dim', type=int, default=256) 
parser.add_argument('--tlayer-dim', type=int, default=256) 

parser.add_argument('--gconv-dropout', type=float, default=0.5) 
parser.add_argument('--tlayer-dropout', type=float, default=0.5) 
